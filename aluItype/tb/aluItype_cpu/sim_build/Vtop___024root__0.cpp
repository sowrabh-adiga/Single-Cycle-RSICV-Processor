...
extern const VlUnpacked<CData/*0:0*/, 128> Vtop__ConstPool__TABLE_hfcda8405_0;
extern const VlUnpacked<CData/*1:0*/, 128> Vtop__ConstPool__TABLE_ha5d10213_0;
...
extern const VlUnpacked<CData/*1:0*/, 128> Vtop__ConstPool__TABLE_h6e63f2db_0;
...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__reg_write 
        = Vtop__ConstPool__TABLE_hfcda8405_0[__Vtableidx1];
    vlSelfRef.cpu__DOT__control_unit__DOT__imm_source 
        = Vtop__ConstPool__TABLE_ha5d10213_0[__Vtableidx1];
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__alu_op = 
        Vtop__ConstPool__TABLE_h20586e2e_0[__Vtableidx1];
    vlSelfRef.cpu__DOT__control_unit__DOT__alu_source 
        = Vtop__ConstPool__TABLE_h595ba012_0[__Vtableidx1];
    vlSelfRef.cpu__DOT__control_unit__DOT__write_back_source 
        = Vtop__ConstPool__TABLE_h6e63f2db_0[__Vtableidx1];
    vlSelfRef.cpu__DOT__control_unit__DOT__branch = 
        Vtop__ConstPool__TABLE_hbd623705_0[__Vtableidx1];
    vlSelfRef.cpu__DOT__control_unit__DOT__jump = Vtop__ConstPool__TABLE_h971f8d58_0
        [__Vtableidx1];
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__alu_control 
        = Vtop__ConstPool__TABLE_hd4d2f8a7_0[__Vtableidx2];
            ...
            ? ((1U & (IData)(vlSelfRef.cpu__DOT__sign_extender__DOT__imm_source))
                ? (((- (IData)((1U & (vlSelfRef.cpu__DOT__sign_extender__DOT__raw_src 
                    ...
                    << 0x00000014U) | ((((0x000001feU 
                                          & (vlSelfRef.cpu__DOT__sign_extender__DOT__raw_src 
                                             >> 4U)) 
                                         | (1U & (vlSelfRef.cpu__DOT__sign_extender__DOT__raw_src 
                                                  >> 0x0000000dU))) 
                                        << 0x0000000bU) 
                                       | (0x000007feU 
                                          & (vlSelfRef.cpu__DOT__sign_extender__DOT__raw_src 
    ...
    vlSelfRef.cpu__DOT__pc_target = (vlSelfRef.cpu__DOT__immediate 
                                     + vlSelfRef.cpu__DOT__pc);
    ...
    vlSelfRef.cpu__DOT__alu_inst__DOT__alu_result = 
        ((4U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
          ? 0U : ((2U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
                   ? ((1U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
                       ...
                       : (vlSelfRef.cpu__DOT__alu_inst__DOT__src1 
                          & vlSelfRef.cpu__DOT__alu_inst__DOT__src2))
                   : ((1U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
                       ? ((IData)(1U) + ((~ vlSelfRef.cpu__DOT__alu_inst__DOT__src2) 
                                         + vlSelfRef.cpu__DOT__alu_inst__DOT__src1))
                       : (vlSelfRef.cpu__DOT__alu_inst__DOT__src1 
                          + vlSelfRef.cpu__DOT__alu_inst__DOT__src2))));
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__pc_source 
        = (((IData)(vlSelfRef.cpu__DOT__control_unit__DOT__alu_zero) 
            & (IData)(vlSelfRef.cpu__DOT__control_unit__DOT__branch)) 
    ...
    if ((0U == (IData)(vlSelfRef.cpu__DOT__write_back_source))) {
        vlSelfRef.cpu__DOT__write_back_data = vlSelfRef.cpu__DOT__alu_result;
    } else if ((1U == (IData)(vlSelfRef.cpu__DOT__write_back_source))) {
        vlSelfRef.cpu__DOT__write_back_data = vlSelfRef.cpu__DOT__mem_read;
    } else if ((2U == (IData)(vlSelfRef.cpu__DOT__write_back_source))) {
        vlSelfRef.cpu__DOT__write_back_data = vlSelfRef.cpu__DOT__pc_plus_four;
    }
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/aluItype/tb/aluItype_cpu/../../aluItype/aluItype.sv", 1, "", "Input combinational region did not converge after 100 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("/home/kali/riscv/aluItype/tb/aluItype_cpu/../../aluItype/aluItype.sv", 1, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("/home/kali/riscv/aluItype/tb/aluItype_cpu/../../aluItype/aluItype.sv", 1, "", "Active region did not converge after 100 tries");
            }
