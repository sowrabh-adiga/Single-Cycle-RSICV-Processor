...
class alignas(VL_CACHE_LINE_BYTES) Vtop___024root final {
  public:
    ...
    struct {
        ...
        CData/*2:0*/ cpu__DOT__control_unit__DOT__alu_control;
        CData/*1:0*/ cpu__DOT__control_unit__DOT__imm_source;
    ...
    static constexpr VlWide<4>/*127:0*/ cpu__DOT__instruction_memory__DOT__mem_init = VlWide<4>{{0x2e686578, 0x6d6f7279, 0x5f696d65, 0x74657374}};
