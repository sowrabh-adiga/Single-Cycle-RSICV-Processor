    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_cpu->varInsert("f3", &(TOP.cpu__DOT__f3), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,2,0);
    ...
    __Vscopep_cpu->varInsert("pc_plus_four", &(TOP.cpu__DOT__pc_plus_four), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    ...
    __Vscopep_cpu->varInsert("pc_target", &(TOP.cpu__DOT__pc_target), false, VLVT_UINT32, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,31,0);
    ...
    __Vscopep_cpu->varInsert("second_add_source", &(TOP.cpu__DOT__second_add_source), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
    ...
    __Vscopep_cpu__control_unit->varInsert("pc_source", &(TOP.cpu__DOT__control_unit__DOT__pc_source), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
    ...
    __Vscopep_cpu__control_unit->varInsert("second_add_source", &(TOP.cpu__DOT__control_unit__DOT__second_add_source), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
