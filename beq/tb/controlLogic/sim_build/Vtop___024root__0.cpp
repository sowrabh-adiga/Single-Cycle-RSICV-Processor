...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.control__DOT__reg_write = Vtop__ConstPool__TABLE_h4803636c_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__imm_source = Vtop__ConstPool__TABLE_h54314708_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__mem_write = Vtop__ConstPool__TABLE_h85fa6153_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__alu_op = Vtop__ConstPool__TABLE_hf8715a2e_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__alu_source = Vtop__ConstPool__TABLE_hc44c848e_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__write_back_source = Vtop__ConstPool__TABLE_hd1fd398a_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__branch = Vtop__ConstPool__TABLE_hbd623705_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__jump = Vtop__ConstPool__TABLE_h81ccfef0_0
        [__Vtableidx1];
    ...
    vlSelfRef.control__DOT__alu_control = Vtop__ConstPool__TABLE_hd4d2f8a7_0
        [__Vtableidx2];
    vlSelfRef.control__DOT__assert_branch = ((0U == (IData)(vlSelfRef.control__DOT__func3)) 
                                             & ((IData)(vlSelfRef.control__DOT__alu_zero) 
                                                & (IData)(vlSelfRef.control__DOT__branch)));
    vlSelfRef.alu_control = vlSelfRef.control__DOT__alu_control;
    vlSelfRef.control__DOT__pc_source = (((IData)(vlSelfRef.control__DOT__assert_branch) 
                                          & (0x63U 
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/beq/tb/controlLogic/../../src/control.sv", 1, "", "Input combinational region did not converge after 100 tries");
        }
