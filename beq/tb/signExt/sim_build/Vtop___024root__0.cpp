...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.signext__DOT__gathered_imm = (0x00000fffU 
                                            & ((0U 
                                                    ...
                                                    ((0x00000800U 
                                                     ...
                                                     | ((0x000007e0U 
                                                        ...
                                                        | (0x0000001eU 
                                                           & vlSelfRef.signext__DOT__raw_src)))
                                                     : 0U))));
    vlSelfRef.signext__DOT__immediate = ((2U == (IData)(vlSelfRef.signext__DOT__imm_source))
                                          ? (((- (IData)(
                                                         (1U 
                                                          & (vlSelfRef.signext__DOT__raw_src 
                                                             >> 0x00000018U)))) 
                                              << 0x0000000cU) 
                                             | (IData)(vlSelfRef.signext__DOT__gathered_imm))
                                          : (((- (IData)(
                                                         (1U 
                                                          & ((IData)(vlSelfRef.signext__DOT__gathered_imm) 
                                                             >> 0x0000000bU)))) 
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/beq/tb/signExt/../../src/signext.sv", 3, "", "Input combinational region did not converge after 100 tries");
        }
...
void Vtop___024root___eval_debug_assertions(Vtop___024root* vlSelf) {
    ...
    if (VL_UNLIKELY(((vlSelfRef.imm_source & 0xfcU)))) {
