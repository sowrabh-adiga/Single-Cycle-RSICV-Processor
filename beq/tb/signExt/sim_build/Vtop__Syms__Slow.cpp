    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_TOP->varInsert("imm_source", &(TOP.imm_source), false, VLVT_UINT8, VLVD_IN|VLVF_PUB_RW, 0, 1 ,1,0);
    ...
    __Vscopep_signext->varInsert("gathered_imm", &(TOP.signext__DOT__gathered_imm), false, VLVT_UINT16, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,11,0);
    __Vscopep_signext->varInsert("imm_source", &(TOP.signext__DOT__imm_source), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 1 ,1,0);
