    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_cpu__control_unit->varInsert("write_back_source", &(TOP.cpu__DOT__control_unit__DOT__write_back_source), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
