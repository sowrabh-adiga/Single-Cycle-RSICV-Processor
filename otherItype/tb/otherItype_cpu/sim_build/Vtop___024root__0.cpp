...
extern const VlUnpacked<CData/*3:0*/, 32> Vtop__ConstPool__TABLE_h5897f858_0;
...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__reg_write 
        = Vtop__ConstPool__TABLE_h174929d0_0[__Vtableidx1];
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__write_back_source 
        = Vtop__ConstPool__TABLE_hd1d6481a_0[__Vtableidx1];
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__jump = Vtop__ConstPool__TABLE_h971f8d58_0
        [__Vtableidx1];
    vlSelfRef.cpu__DOT__control_unit__DOT__second_add_source 
    ...
    vlSelfRef.cpu__DOT__control_unit__DOT__alu_control 
        = Vtop__ConstPool__TABLE_h5897f858_0[__Vtableidx2];
    ...
    vlSelfRef.cpu__DOT__sign_extender__DOT__immediate 
        = ((4U & (IData)(vlSelfRef.cpu__DOT__sign_extender__DOT__imm_source))
            ? ((2U & (IData)(vlSelfRef.cpu__DOT__sign_extender__DOT__imm_source))
                ? 0U : ((1U & (IData)(vlSelfRef.cpu__DOT__sign_extender__DOT__imm_source))
                         ? 0U : (0xfffff000U & (vlSelfRef.cpu__DOT__sign_extender__DOT__raw_src 
                                                << 7U))))
            : ((2U & (IData)(vlSelfRef.cpu__DOT__sign_extender__DOT__imm_source))
    ...
    __VdfgRegularize_h6e95ff9d_0_1 = (vlSelfRef.cpu__DOT__immediate 
                                      + vlSelfRef.cpu__DOT__pc);
    vlSelfRef.cpu__DOT__alu_src2 = ((IData)(vlSelfRef.cpu__DOT__alu_source)
                                     ? vlSelfRef.cpu__DOT__immediate
                                     : vlSelfRef.cpu__DOT__read_reg2);
    vlSelfRef.cpu__DOT__pc_target = __VdfgRegularize_h6e95ff9d_0_1;
    vlSelfRef.cpu__DOT__pc_plus_second_add = ((IData)(vlSelfRef.cpu__DOT__second_add_source)
                                               ? vlSelfRef.cpu__DOT__immediate
    ...
    vlSelfRef.cpu__DOT__alu_inst__DOT__alu_result = 
        ((8U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
          ? 0U : ((4U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
                   ? ((2U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
                       ? ((1U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
                           ...
                           : 0U) : ((1U & (IData)(vlSelfRef.cpu__DOT__alu_inst__DOT__alu_control))
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/otherItype/tb/otherItype_cpu/../../otherItype/otherItype.sv", 1, "", "Input combinational region did not converge after 100 tries");
        }
    ...
    do {
...
#endif
            VL_FATAL_MT("/home/kali/riscv/otherItype/tb/otherItype_cpu/../../otherItype/otherItype.sv", 1, "", "NBA region did not converge after 100 tries");
        }
        ...
        do {
            if (VL_UNLIKELY(((0x00000064U < vlSelfRef.__VactIterCount)))) {
                ...
                Vtop___024root___dump_triggers__act(vlSelfRef.__VactTriggered, "act"s);
#endif
                VL_FATAL_MT("/home/kali/riscv/otherItype/tb/otherItype_cpu/../../otherItype/otherItype.sv", 1, "", "Active region did not converge after 100 tries");
            }
