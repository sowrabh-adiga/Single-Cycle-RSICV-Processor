...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.control__DOT__jump = Vtop__ConstPool__TABLE_h971f8d58_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__second_add_source = Vtop__ConstPool__TABLE_h1d8d83a7_0
        [__Vtableidx1];
    ...
    vlSelfRef.control__DOT__alu_control = Vtop__ConstPool__TABLE_h5897f858_0
        [__Vtableidx2];
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/otherItype/tb/controlLogic/../../src/control.sv", 4, "", "Input combinational region did not converge after 100 tries");
        }
