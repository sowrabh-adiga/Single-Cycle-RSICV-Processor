    ...
    , TOP{this, namep}
{
    ...
    __Vscopep_TOP->varInsert("second_add_source", &(TOP.second_add_source), false, VLVT_UINT8, VLVD_OUT|VLVF_PUB_RW, 0, 0);
    ...
    __Vscopep_control->varInsert("second_add_source", &(TOP.control__DOT__second_add_source), false, VLVT_UINT8, VLVD_NODIR|VLVF_PUB_RW, 0, 0);
