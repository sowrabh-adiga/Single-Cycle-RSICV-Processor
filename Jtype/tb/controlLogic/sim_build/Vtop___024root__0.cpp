...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.control__DOT__reg_write = Vtop__ConstPool__TABLE_h683af2a5_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__imm_source = Vtop__ConstPool__TABLE_ha5d10213_0
        [__Vtableidx1];
    ...
    vlSelfRef.control__DOT__alu_source = Vtop__ConstPool__TABLE_hc44c848e_0
        [__Vtableidx1];
    vlSelfRef.control__DOT__write_back_source = Vtop__ConstPool__TABLE_h6e63f2db_0
        [__Vtableidx1];
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/Jtype/tb/controlLogic/../../src/control.sv", 4, "", "Input combinational region did not converge after 100 tries");
        }
