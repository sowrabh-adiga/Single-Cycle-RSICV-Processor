...
void Vtop___024root___ico_sequent__TOP__0(Vtop___024root* vlSelf) {
    ...
    vlSelfRef.alu__DOT__alu_result = ((0U == (IData)(vlSelfRef.alu__DOT__alu_control))
                                       ...
                                       : ((2U == (IData)(vlSelfRef.alu__DOT__alu_control))
                                           ? (vlSelfRef.alu__DOT__src1 
                                              & vlSelfRef.alu__DOT__src2)
                                           : ((3U == (IData)(vlSelfRef.alu__DOT__alu_control))
                                               ? (vlSelfRef.alu__DOT__src1 
                                                  | vlSelfRef.alu__DOT__src2)
                                               : 0U)));
...
void Vtop___024root___eval(Vtop___024root* vlSelf) {
    ...
    do {
        if (VL_UNLIKELY(((0x00000064U < __VicoIterCount)))) {
            ...
            Vtop___024root___dump_triggers__ico(vlSelfRef.__VicoTriggered, "ico"s);
#endif
            VL_FATAL_MT("/home/kali/riscv/Rtype_and_or/tb/alu/../../src/alu.sv", 2, "", "Input combinational region did not converge after 100 tries");
        }
